<?php
	...
	if($_POST){
		...
		$ruta = $_FILES['iFoto']['tmp_name'];
		$destino = "images/".$foto;

		copy($ruta, $destino);
		$pelicula->Foto = $destino;
...
<html>
	...
	<body>
		...
		<div class="container">
			<form role="form" method="post" action="RegistrarPelicula.php" enctype="multipart/form-data" autocomplete="off">
				<div class="col-md-4">
					<div class="form-group">
						<label for="iTitulo" class="control-label"><h4 class="hcolor">Titulo:</h4></label>
						<input required type="text" class="form-control" name="iTitulo" id="iTitulo">
					</div>
					<div class="form-group">
						<label for="iGenero" class="control-label"><h4 class="hcolor">Genero:</h4></label>
						<select required class="form-control" id="iGenero" name="iGenero">
							<option></option>
					...
					<div class="form-group">
						...
						<input required type="text" class="form-control" name="iDuracion" id="iDuracion" value="00:00:00">
					</div>
					<div class="form-group">
						<label for="iProductora" class="control-label"><h4 class="hcolor">Productora:</h4></label>
						<input required type="text" class="form-control" name="iProductora" id="iProductora">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="iDirector" class="control-label"><h4 class="hcolor">Director:</h4></label>
						<input required type="text" class="form-control" name="iDirector" id="iDirector">
					</div>
					<div class="form-group">
						<label for="iFecha" class="control-label"><h4 class="hcolor">Fecha de Lanzamiento:</h4></label>
						<input required type="date" class="form-control" name="iFecha" id="iFecha">
					</div>
					<div class="form-group">
						<label for="iProtagonistas" class="control-label"><h4 class="hcolor">Protagonistas:</h4></label>
						<textarea required class="form-control" name="iProtagonistas" id="iProtagonistas" rows="3"></textarea>
					</div>
					<div class="form-group">
						<input required type="file" class="form-control" name="iFoto" id="iFoto">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="iIdioma" class="control-label"><h4 class="hcolor">Idioma:</h4></label>
						<select required class="form-control" id="iIdioma" name="iIdioma">
							<option></option>
					...
					<div class="form-group">
						...
						<select required class="form-control" id="iPais" name="iPais">
							<option></option>
					...
					<div class="form-group">
						...
						<textarea required class="form-control" name="iResumen" id="iResumen" rows="3"></textarea>
					</div>
					<div class="form-group">
						<button type="reset" class="btn btn-danger col-md-offset-6">Cancelar</button>
